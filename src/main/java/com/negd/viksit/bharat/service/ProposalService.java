...
public class ProposalService {
    ...
    private ProposalDto mapToDto(Proposal entity) {
        return ProposalDto.builder()
                .id(entity.getId())
                .ideaProposalTitle(entity.getIdeaProposalTitle())
                .proposalDescription(entity.getProposalDescription())
                ...
                .timelineStart(entity.getTimelineStart())
                .timelineEnd(entity.getTimelineEnd())
                .build();
    }
    ...
    private Proposal mapToEntity(ProposalDto dto) {
        return Proposal.builder()
                .id(dto.getId())
                .ideaProposalTitle(dto.getIdeaProposalTitle())
                .proposalDescription(dto.getProposalDescription())
                ...
                .timelineStart(dto.getTimelineStart())
                .timelineEnd(dto.getTimelineEnd())
                .build();
    }
    ...
    public ProposalDto getOne(Long id) {
        return repository.findById(id).map(this::mapToDto).orElseThrow(() -> new RuntimeException("Proposal not found"));
    }
